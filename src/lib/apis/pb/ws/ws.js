    ...
    hiqidashi.WsCommunicationData = (function() {
        ...
        WsCommunicationData.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.editHiqidashi = $root.hiqidashi.WsEditHiqidashi.decode(reader, reader.uint32());
                    break;
                case 5:
        ...
        WsCommunicationData.verify = function verify(message) {
            ...
            if (message.createHiqidashi != null && message.hasOwnProperty("createHiqidashi")) {
                ...
                properties.payload = 1;
                {
                    let error = $root.hiqidashi.WsCreateHiqidashi.verify(message.createHiqidashi);
                    if (error)
                        return "createHiqidashi." + error;
                }
            }
            if (message.editHiqidashi != null && message.hasOwnProperty("editHiqidashi")) {
                if (properties.payload === 1)
                    return "payload: multiple values";
                properties.payload = 1;
                {
                    let error = $root.hiqidashi.WsEditHiqidashi.verify(message.editHiqidashi);
                    if (error)
                        return "editHiqidashi." + error;
                }
            }
            if (message.deleteHiqidashi != null && message.hasOwnProperty("deleteHiqidashi")) {
                if (properties.payload === 1)
                    return "payload: multiple values";
                properties.payload = 1;
                {
                    let error = $root.hiqidashi.WsDeleteHiqidashi.verify(message.deleteHiqidashi);
                    if (error)
        ...
        WsCommunicationData.toObject = function toObject(message, options) {
            ...
            if (message.createHiqidashi != null && message.hasOwnProperty("createHiqidashi")) {
                ...
                if (options.oneofs)
                    object.payload = "createHiqidashi";
            }
            if (message.editHiqidashi != null && message.hasOwnProperty("editHiqidashi")) {
                object.editHiqidashi = $root.hiqidashi.WsEditHiqidashi.toObject(message.editHiqidashi, options);
                if (options.oneofs)
                    object.payload = "editHiqidashi";
            }
            if (message.deleteHiqidashi != null && message.hasOwnProperty("deleteHiqidashi")) {
                object.deleteHiqidashi = $root.hiqidashi.WsDeleteHiqidashi.toObject(message.deleteHiqidashi, options);
                if (options.oneofs)
